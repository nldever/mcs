...
```bash
kotlinc MCScriptCompiler.kt -include-runtime -d mcs.jar
```

### Вариант 2: Использование как скрипт

```bash
kotlin MCScriptCompiler.kt <путь>
```
...
Любая строка, начинающаяся с `/`, копируется как есть:
...
**Автор:** Переведено с JavaScript на Kotlin  
**Версия:** 1.0.0
